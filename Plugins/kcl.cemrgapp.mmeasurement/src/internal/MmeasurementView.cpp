...
void MmeasurementView::OnSelectionChanged(berry::IWorkbenchPart::Pointer /*source*/,
...
void MmeasurementView::CalcDistButton() {
    ...
    for (int frame=0; frame<timePoints*smoothness; frame++) {
        ...
        AddToStorage(std::to_string(frame), set);
    }
...
void MmeasurementView::AddToStorage(std::string nodeName, mitk::BaseData* data) {
