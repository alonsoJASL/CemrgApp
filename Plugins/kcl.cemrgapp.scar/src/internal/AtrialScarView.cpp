...
void AtrialScarView::EnableManualAnalysis(){ // Automatic segmentation slot
...
void AtrialScarView::AutomaticAnalysis(){ // Automatic segmentation slot

  this->RestartPipeline();
  MITK_INFO << "Function not supported in this version.";
}
...
void AtrialScarView::ExtraCalcs() {
  ...
  //Ask the user for a dir to store data
  QMessageBox::warning(NULL, "Attention", "This functionality is not supported in this version.");
}
